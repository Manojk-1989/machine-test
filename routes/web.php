...
Route::get('/admin/company/{encriptedId}/edit', [CompanyController::class, 'edit'])->name('company.edit');
Route::delete('/admin/delete-company/{id}', [CompanyController::class, 'destroy'])->name('company.destroy');
...
Route::get('/admin/employ/{encriptedId}/edit', [EmployeeController::class, 'edit'])->name('employ.edit');
Route::delete('/admin/delete-employ/{id}', [EmployeeController::class, 'destroy'])->name('employ.destroy');
